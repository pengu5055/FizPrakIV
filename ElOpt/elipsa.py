...
kot = np.genfromtxt("Elipsa.txt", skip_header=1, usecols=0)
kot_rad = np.array([np.deg2rad(value) for value in kot])
I = np.genfromtxt("Elipsa.txt", skip_header=1, usecols=1)
I_0 = 4.02 * 10**-4
...
plt.title("Moc v odvisnosti zasuka pol1 glede na pol2")
