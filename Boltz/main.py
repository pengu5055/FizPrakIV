...
U = np.genfromtxt("Main_Export.txt", usecols=0, skip_header=1)
Ic = np.genfromtxt("Main_Export.txt", usecols=1, skip_header=1)  # Column used determines data set for I_c (different T)
...
plt.title(r"Linearizirana odvisnost $I_C$ od $U_{BE}$ pri $T=297K$")
